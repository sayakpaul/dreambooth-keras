...
class DatasetUtils:
    ...
    def __init__(
        ...
        Args:
            ...
            train_text_encoder: Boolean flag to denote if the text encoder is
                also fine-tuned.
        """
    ...
    def _get_embedded_captions(self, num_instance_images, num_class_images) -> np.ndarray:
    ...
    def _process_image(self, image_path, text) -> Tuple[tf.Tensor, tf.Tensor]:
    ...
    def _apply_augmentation(self, image_batch, text_batch) -> Tuple[tf.Tensor, tf.Tensor]:
    ...
    def _assemble_dataset(
        self, image_paths, texts, instance_only=True
    ) -> tf.data.Dataset:
    ...
    def prepare_datasets(self) -> tf.data.Dataset:
        ...
        if not self.train_text_encoder:
            ...
            text_batch = self._tokenize_text_batch(instance_captions, class_captions)
